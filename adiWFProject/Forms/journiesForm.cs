...
namespace adiWFProject.Forms
{
    public partial class journiesForm : Form
    {
        ...
        private void CANCEL_Click(object sender, EventArgs e)
        {
            ...
            {
                db.Delete(Convert.ToInt32(dr["JourneyKode"]));
        ...
        private void add_Click(object sender, EventArgs e)
        {
            //בדיקות תקינות 
            journies db = new journies();
            if (textBox1.Text == "" || dateTimePicker.Text == null || textBox2.Text == "" || textBox3.Text == null || textBox4.Text == "" || checkBox.Text == "" || textBox6.Text == null)
            {
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            c.JourneyCode = Convert.ToInt32(textBox7.Text);

            if (c.Found(c.JourneyCode) == false)
            {
                MessageBox.Show(("לא נמצא מסע בעל קוד זה") + " " + c.JourneyCode);
            }

            else
            {
                DataTable ds = c.GetInfoByIdKey(c.JourneyCode).Tables[0];
                textBox1.Text = ds.Rows[0]["journeyName"].ToString();
                dateTimePicker.Text = ds.Rows[0]["journeyDate"].ToString();
                ...
                //checkBox.Text = ds.Rows[0]["securityinsure"].ToString();
